...
// variable play is used to start and pause the game 
let play = true

// calScore is made ofor calculating the game score
const calcScore =()=>{
     score -=1
    ...
    if (play){
     ...
     let userValue = guess
      ...
      if(score>0){
               ...
               if(userValue>20 || userValue<1 ) msg("❌ Enter a Number Between \"1 to 20\" ")
